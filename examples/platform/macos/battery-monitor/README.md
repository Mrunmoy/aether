...
```bash
python3 -m tools.ipcgen examples/platform/macos/battery-monitor/BatteryMonitor.idl --outdir examples/platform/macos/battery-monitor/gen
```
...
```bash
# Terminal 1
./build/examples/platform/macos/battery-monitor/battery_device

# Terminal 2
./build/examples/platform/macos/battery-monitor/battery_client
```
