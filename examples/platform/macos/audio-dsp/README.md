...
```bash
python3 -m tools.ipcgen examples/platform/macos/audio-dsp/AudioDsp.idl --outdir examples/platform/macos/audio-dsp/gen
```
...
```bash
# Terminal 1
./build/examples/platform/macos/audio-dsp/dsp_device

# Terminal 2
./build/examples/platform/macos/audio-dsp/dsp_dashboard
```
