...
```bash
python3 -m tools.ipcgen examples/platform/macos/disk-usage/DiskUsage.idl --outdir examples/platform/macos/disk-usage/gen
```
...
```bash
# Terminal 1
./build/examples/platform/macos/disk-usage/disk_device

# Terminal 2
./build/examples/platform/macos/disk-usage/disk_client
```
