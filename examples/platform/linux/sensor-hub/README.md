...
```bash
python3 -m tools.ipcgen examples/platform/linux/sensor-hub/SensorHub.idl --outdir examples/platform/linux/sensor-hub/gen
```
...
```bash
# Terminal 1
./build/examples/platform/linux/sensor-hub/sensor_device

# Terminal 2
./build/examples/platform/linux/sensor-hub/sensor_dashboard
```
