...
```bash
python3 -m tools.ipcgen examples/platform/linux/sysmon/SysMon.idl --outdir examples/platform/linux/sysmon/gen
```
...
```bash
# Terminal 1
./build/examples/platform/linux/sysmon/sysmon_device

# Terminal 2
./build/examples/platform/linux/sysmon/sysmon_client
```
