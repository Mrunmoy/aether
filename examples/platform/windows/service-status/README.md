...
```bash
python3 -m tools.ipcgen examples/platform/windows/service-status/ServiceStatus.idl --outdir examples/platform/windows/service-status/gen
```
...
```bash
# Terminal 1
./build/examples/platform/windows/service-status/svcstat_device

# Terminal 2
./build/examples/platform/windows/service-status/svcstat_client
```
