...
```bash
python3 -m tools.ipcgen examples/platform/windows/motor-controller/MotorController.idl --outdir examples/platform/windows/motor-controller/gen
```
...
```bash
# Terminal 1
./build/examples/platform/windows/motor-controller/motor_device

# Terminal 2
./build/examples/platform/windows/motor-controller/motor_dashboard
```
