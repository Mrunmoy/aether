...
```bash
python3 -m tools.ipcgen examples/platform/windows/can-bus-ecu/CanBusEcu.idl --outdir examples/platform/windows/can-bus-ecu/gen
```
...
```bash
# Terminal 1
./build/examples/platform/windows/can-bus-ecu/ecu_device

# Terminal 2
./build/examples/platform/windows/can-bus-ecu/ecu_dashboard
```
