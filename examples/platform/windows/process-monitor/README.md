...
```bash
python3 -m tools.ipcgen examples/platform/windows/process-monitor/ProcessMonitor.idl --outdir examples/platform/windows/process-monitor/gen
```
...
```bash
# Terminal 1
./build/examples/platform/windows/process-monitor/procmon_device

# Terminal 2
./build/examples/platform/windows/process-monitor/procmon_client
```
