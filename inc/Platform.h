...
namespace aether::ipc::platform
{
    ...
    // macOS: pathname UDS SOCK_STREAM.
    ...
    // Linux/macOS also transfers the shared-memory fd via SCM_RIGHTS.
    ...
    // Linux: memfd_create + ftruncate. macOS: shm_open. Windows: named file mapping.
    // Returns a valid handle on success, kInvalidHandle on failure.
